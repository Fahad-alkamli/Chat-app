...
public class adminControlPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     void GetTotalUsers(final View view)
    {
     ...
     void GetTotalChatHistory(final View view)
    {
        view.setEnabled(false);
     ...
     void AverageUnreadMessages(final View view)
    {
        view.setEnabled(false);
    ...
    void getTop10Words(final ListView topWordsListView)
    {
